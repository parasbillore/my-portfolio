            ...
            <div className='left'>
              ...
              <div className='content'>
               ...
               <div>
                ...
                <a href={resume} download="Paras_Billore_Resume" target="_blank" rel="noreferrer" >
                                <button className='btn-resume btn_shadow'>
                                Download Resume<i className='fa fa-long-arrow-right'></i>
                                </button>
                                </a>
              ...
              <a href={resume}  target="_blank" rel="noreferrer" >
                                <button className='view-resume btn_shadow'>
                                View Resume<i className='fa fa-long-arrow-right'></i>
                                </button></a>
              </div>
        </div>
      </section>
